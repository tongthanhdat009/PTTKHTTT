...
public class thongKeDoanhThuTheoNam extends JPanel {
    ...
    public thongKeDoanhThuTheoNam(ArrayList<String> maCoSo, int namBatDau, int namKetThuc) {
        this.setBounds(0, 0, 1200, 776);
        bllThongKeDonHang = new BLLThongKeDonHang();
        
        // Lấy dữ liệu doanh thu theo năm
        ArrayList<DTOThongKe> dsThongKe = bllThongKeDonHang.thongKeDoanhThuTheoNam(maCoSo, namBatDau, namKetThuc);
        DefaultCategoryDataset dataset = createDataset(dsThongKe, namBatDau, namKetThuc);

        // Tạo biểu đồ đường
        JFreeChart lineChart = ChartFactory.createLineChart(
                "Doanh thu theo năm", // Tiêu đề biểu đồ
                "Năm", // Trục X
